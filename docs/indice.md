...
| [`s-frontdesk`](paginas/s-frontdesk/briefing.md) | S-FrontDesk (produto da Fábrica de Apps e Soluções, `negocio`) | Agenda e atendimento para clínicas | — | **publicada** (indexável, painel "Produtos dos clientes"; WhatsApp provisório com DDD 20 inexistente) | 2026-09-23 (entregue pelo repositório `sfrontdesk-landing`) | 2026-09-23 (dono) | 2026-09-23 (merge) | 2026-09-23 |
