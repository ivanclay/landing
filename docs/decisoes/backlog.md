...
| B-07 | `og:site_name` sai "Médicos" (título do índice) também no hub | Prévia do link com o nome do índice | **Feito em 2026-09-23**: nenhuma página de cliente leva `og:site_name`; o índice leva o nome da Fábrica (ADR-007, D-02 fechada) |
